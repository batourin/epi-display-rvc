...
namespace RVCDisplay
{
    ...
    public class RVCDisplayBridgeJoinMap : DisplayControllerJoinMap
	{
		#region Digital
		...
		public RVCDisplayBridgeJoinMap(uint joinStart)
			: base(joinStart, typeof(RVCDisplayBridgeJoinMap))
		{
		}
	}
}